...
function isTodayMyBirthday() {
  const dat = new Date();
  const myBirth = { day: 11, month: 8 };
  return dat.getDate() === myBirth.day && dat.getMonth() + 1 === myBirth.month;
}
...
*/
function deleteProp(oggetto, par) {
  if (oggetto.hasOwnProperty(par)) {
    delete oggetto[par];
  }
  return oggetto;
}
